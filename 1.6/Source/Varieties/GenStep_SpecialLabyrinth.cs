...
{
    public class GenStep_SpecialLabyrinth : GenStep
    {
        ...
        public override void Generate(Map map, GenStepParams parms)
        {
            ...
            LayoutWorker worker = Definitions.SpecialLabyrinth.Worker;
            int num = 10;
            do
            {
                structureSketch = worker.GenerateStructureSketch(parms2);
            }
            while (!structureSketch.structureLayout.HasRoomWithDef(Definitions.SpecialLabyrinthObelisk) && num-- > 0);
            if (num == 0)
            {
            ...
            SpecialLabyrinthMapComponent component = map.GetComponent<SpecialLabyrinthMapComponent>();
            LayoutRoom firstRoomOfDef = structureSketch.structureLayout.GetFirstRoomOfDef(Definitions.SpecialLabyrinthObelisk);
